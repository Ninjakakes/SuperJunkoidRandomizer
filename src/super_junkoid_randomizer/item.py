...
items_unpackable: Iterable[Item] = (
    Items.MagicBolt, Items.Baseball, Items.Sparksuit, Items.RatCloak, Items.WaveBangle, Items.RatBurst, Items.Feather,
    Items.PurpleLocket, Items.SanguineFin, Items.BloodGem, Items.RatDasher, Items.IceGem, Items.DreamersCrown,
    Items.StormsGem, Items.Wallkicks, Items.DeathGem, Items.MagicBroom, Items.Heart, Items.LuckyFrog, Items.MagicSoap,
